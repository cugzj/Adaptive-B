...
class PPOAvgServer(Server):
    ...
    def run(self):
        ...
        filename = "ppo_anet_" + str(self.config.model) + "_iid[" + str(self.config.data.IID) + \
        ...
        ppo.anet.load_state_dict(torch.load(directory+filename))
        ...
        csvFile2 = open('./save/test/training_accuracy_{}_iid[{}]_bias[{}]_worker[{}]_ep[{}x{}].csv'.
        ...
        plt.savefig('./save/test/fl_{}_iid[{}]_bias[{}]_worker[{}]_ep[{}x{}]_train_accuracy.png'.
                    format(self.config.model, self.config.data.IID,
                           self.config.data.bias['primary'],
                           self.config.clients.total,
                           self.config.fl.episodes,
