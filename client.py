...
class Client(object):
    ...
    def __init__(self, client_id, batch_size):
    ...
    def configure(self, config):
        ...
        # self.batch_size = config.fl.batch_size  # this line should be modified
        logging.debug('batch_size of client [{}]:{}'.format(self.client_id, self.batch_size))

        # Download most recent global model
        path = model_path + '/global.pth'
    ...
    def train(self):
        ...
        logging.debug('Training on client #{}: batch size ={}'.format(self.client_id, self.batch_size))
        # logging.info('Training on client #{}: batch size ={}'.format(self.client_id, self.batch_size))
